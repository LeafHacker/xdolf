...
public class XdolfSlider {
	...
	public XdolfSlider(XdolfWindow window, Value value, int x, int y) {
		this.window = window;
	...
	public XdolfSlider(XdolfWindow window, Value value, int x, int y, float maxValue) {
		this.window = window;
		this.sliderValue = value;
		this.xPos = x;
		this.yPos = y;
	...
	public XdolfSlider(XdolfWindow window, Value value, int x, int y, float minValue, float maxValue, boolean shouldRound) {
		this.window = window;
		this.sliderValue = value;
		this.xPos = x;
		this.yPos = y;
	...
	public void draw(int x) {
		...
		RenderUtils.drawBetterBorderedRect(xPos + window.dragX + 1, yPos + 10 + window.dragY, xPos + 5 + window.dragX + (int)dragX, yPos + 16 + window.dragY, 0.5F, 0xFF000000, 0xFFFF0000);
		RenderUtils.drawBetterBorderedRect(xPos + 2 + window.dragX + (int)dragX, yPos + 10 + window.dragY, xPos + 5 + window.dragX + (int)dragX, yPos + 16 + window.dragY, 0.5F, 0xFF000000, 0xFFFF4c4c);
		//ff3232
