...
public class EntityUtils
{
    ...
    {
        Integer integer = (Integer)mapIdByClass.get(p_getEntityIdByClass_0_);
        return integer == null ? -1 : integer.intValue();
    }

    public static int getEntityIdByLocation(String p_getEntityIdByLocation_0_)
    {
        Integer integer = (Integer)mapIdByLocation.get(p_getEntityIdByLocation_0_);
        return integer == null ? -1 : integer.intValue();
    }

    public static int getEntityIdByName(String p_getEntityIdByName_0_)
    {
        Integer integer = (Integer)mapIdByName.get(p_getEntityIdByName_0_);
        return integer == null ? -1 : integer.intValue();
    }
