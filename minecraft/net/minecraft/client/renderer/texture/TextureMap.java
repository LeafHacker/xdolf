...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        for (Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet())
        {
            ...
            if (lvt_11_2_ < k)
            {
                LOGGER.warn("Texture {} with size {}x{} limits mip level from {} to {}", new Object[] {resourcelocation, Integer.valueOf(textureatlassprite.getIconWidth()), Integer.valueOf(textureatlassprite.getIconHeight()), Integer.valueOf(MathHelper.log2(k)), Integer.valueOf(MathHelper.log2(lvt_11_2_))});
                k = lvt_11_2_;
            }
